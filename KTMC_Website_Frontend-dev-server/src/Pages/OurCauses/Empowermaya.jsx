        ...
        <div className=' container py-lg-5 mt-lg-3 py-3 mt-3'>
          <div className='row'>
            <div className='col-12 col-lg-12 col-md-12'>
              <h3 className='text-center fw-bold'>A Leap of the Champion</h3>
              <p className='text-center p-2 p-md-4'>
                Maya had to deal with huge challenges. She had a strong spirit. KTMC was of considerable help to her. She practiced with intense commitment. Maya jogged with cheer and experience. She had courage in every step. The story of her life motivates us all. Her improvement is praised.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="container p-0 m-auto">
          <div className="yellowrap d-flex">
            ...
            <div className="banner_cta_wrap col-md-6">
              <p className=''>
                Her steps carry the message of hope. She sets an example for others.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className='container-fluid'>
          <div className='row'>
            <div className='col-12 col-lg-12 col-md-12 w-100 img-fluid p-0 position-relative'>
              <img src="./assets/empower/mayabigimg.jpg" alt="empowerment.img" className='w-100 ' />
              <h5 className='position-absolute top-0 start-0 mt-5 translate-middle text-black fs-3 divya-text mx-5'>Maya</h5>
            </div>
            <div className='p-md-5 p-0 big-blackbg position-relative' style={{ marginTop: "-100px" }}>
              ...
              <div className='text-center position-absolute top-50 start-50 translate-middle text-white p-0 my-2 my-md-0'>
                ...
                Maya has reached a point where she addresses many people. She narrates her unbelievable story. The words she speaks are something that inspires courage in others. She demonstrates the feasibility of anything. Her soul appeals to the hearts. She is an instructor on resilience. Maya demonstrates that dreams do come true.
                </p>
                <h4 className='fw-bolder py-0 py-md-2 py-lg-4 smaller-text'>What kind of legacy would you leave?</h4>
                <p className=' smaller-text fs-h lh-md-lg'>
                 Maya was able to walk with confidence. KTMC gave a helping hand. We gave implementation devices. Your contribution will make more stories like hers. We invest in human potential. Come, then, and work with us in this important labour. One way, a world of opportunity is created. Assist us in activating all capabilities.
                </p>
              </div>
                ...
                <div className='col-md-6 col-lg-9 d-flex '>
                  <div>
                    <h3 className="p-3 fs-h ">
                     Save a life. Donate to the Kovai Tech Member Chamber
                    </h3>
                  </div>
