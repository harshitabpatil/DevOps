        ...
        <div className=' container py-lg-5 mt-lg-3 py-3 mt-3'>
          <div className='row'>
            <div className='col-12 col-lg-12 col-md-12'>
              <h3 className='text-center fw-bold'>A Remarkable Recovery</h3>
              <p className='text-center p-2 p-md-4'>
                Rahul needed urgent medical care. His situation was critical. Our team provided fast support. We acted quickly. He received life-saving treatment. The medical care was vital. His recovery was truly remarkable. We are all so happy for him. His journey inspires many.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="container p-0 m-auto">
          <div className="yellowrap d-flex">
            ...
            <div className="banner_cta_wrap col-md-6">
              <p className=''>
                His healing journey gives hope. He shows strength to others.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className='container-fluid'>
          <div className='row'>
            <div className='col-12 col-lg-12 col-md-12 w-100 img-fluid p-0 position-relative'>
              <img src="./assets/empower/rahulbigimg.jpg" alt="empowerment.img" className='w-100 ' />
              <h5 className='position-absolute top-0 start-10 translate-middle text-white fs-3 divya-text mt-5 mx-5'>Rahul</h5>
            </div>
            <div className='p-md-5 p-0 big-blackbg position-relative' style={{ marginTop: "-100px" }}>
              ...
              <div className='text-center position-absolute top-50 start-50 translate-middle text-white p-0 my-2 my-md-0'>
                <p className=' smaller-text fs-h lh-md-lg'>
                  Rahul now lives a full life. He shares his story of healing. His words spark courage in others. He shows that recovery is possible. His spirit touches every heart. He teaches us about resilience. Rahul proves wellness can come true
                </p>
                <h4 className='fw-bolder py-0 py-md-2 py-lg-4 smaller-text'>Whose recovery will you champion?</h4>
                <p className=' smaller-text fs-h lh-md-lg'>
                  Rahul's courage opened his path. KTMC offered a helping hand. We provided tools for his healing. Your support enables more stories like his. We invest in human potential. Join us in this vital work. Together, we build a world of wellness.
                </p>
              </div>
                ...
                <div className='col-md-6 col-lg-9 d-flex '>
                  <div>
                    <h3 className="p-3 fs-h ">
                      Your donation directly funds every recovery.
                    </h3>
                  </div>
