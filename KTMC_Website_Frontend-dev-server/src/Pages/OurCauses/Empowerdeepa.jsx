        ...
        <div className=' container py-lg-5 mt-lg-3 py-3 mt-3'>
          <div className='row'>
            <div className='col-12 col-lg-12 col-md-12'>
              <h3 className='text-center fw-bold'>Dreams on Track</h3>
              <p className='text-center p-2 p-md-4'>
               Deepa fantasized about the competitions. There were numerous obstacles that she encountered. It was a life-saving opportunity that our programs presented. She has discovered her real talent. She exercised very passionately. She now runs in delight. Her path is brilliant. She is an inspiration to everyone.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="container p-0 m-auto">
          <div className="yellowrap d-flex">
            ...
            <div className="banner_cta_wrap col-md-6">
              <p className=''>
               The fact that she is fast is about perseverance. She empowers thousands of people.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className='container-fluid'>
          <div className='row'>
            <div className='col-12 col-lg-12 col-md-12 w-100 img-fluid p-0 position-relative'>
              <img src="./assets/empower/deepabigimg.jpg" alt="empowerment.img" className='w-100 ' />
              <h5 className='position-absolute top-0 start-0 translate-middle text-white fs-3 divya-text mt-5 mx-5'>Deepa</h5>
            </div>
            <div className='p-md-5 p-0 big-blackbg position-relative' style={{ marginTop: "-100px" }}>
              ...
              <div className='text-center position-absolute top-50 start-50 translate-middle text-white p-0 my-2 my-md-0'>
               ...
               Deepa is now competing in a broad spectrum. She is a frequent winner of medals. Her accomplishments are a demonstration of spirit. She is the symbol of those who struggle. She is diligent. She demonstrates that dreams are real. Many are encouraged by Deepa. In each step, she is strong.
                </p>
                <h4 className='fw-bolder py-0 py-md-2 py-lg-4 smaller-text'>Whose dreams will you stand up to?</h4>
                <p className=' smaller-text fs-h lh-md-lg'>
                 The ambition of Deepa opened her way. KTMC gave the chance. We provided her with what would give her success. Your contribution makes it possible so that more stories could unfold like hers. We commit to human potential. Come and work with us on this crucial task. It is through us all that we develop an achievement world. Assist us in making every dream come true.
                </p>
              </div>
