    ...
    <div>
      ...
      <>
        ...
        <div className="container pt-5">
          <div className="row">
            <div className="col-12 d-md-flex justify-content-between">
              <div className=" col-12 col-md-6 d-flex justify-content-md-start justify-content-center">
                <h3 className="fs-1 fw-bold">Success Story</h3>
              </div>
          ...
          <div className="row p-2 gap-lg-5 gap-5 gap-md-0 pt-4 d-flex justify-content-between">
            <div className="col-12 col-lg-5 col-md-6  d-lg-flex gap-2 Cardshoveranimate">
              <div className="col-12 col-lg-6  col-md-12 p-0">
                <img
                  src="/assets/success story/success event1.jpg"
                  alt="Success Story"
                  className="img-fluid w-100 h-100 object-fit-cover"
                />
              </div>
              <div className="col-12 col-lg-6 col-md-12 p-0 d-flex flex-column justify-content-between">
                <div>
                  <h5>Ready to place a smile on this child's face?</h5>
                  <p className="lh-lg">
                    Lorem ipsum dolor sit amet, <b>consectetur</b> adipiscing
                    elit, sed do eiusmod tempor incididunt ut labore et dolore
                    magna aliqua. Ut enim ad minim veniam, quis nostrud.Ut enim
                    ad minim veniam, quis nostrud.adipiscing elit, sed do
                    nostrud.adipiscing elit, sed do
                  </p>
                </div>
                <div className="w-75">
                  <button
                    className="btn btn-warning rounded-0 text-white w-100 fs-6 black-btn"
                    onClick={() => {
                      navigate("/donate-success-story-detail");
                      window.scrollTo(0, 0);
                    }}
                  >
                    Read More
            ...
            <div className="col-12 col-lg-5 col-md-6  d-lg-flex gap-2 Cardshoveranimate">
              <div className="col-12 col-lg-6  col-md-12 p-0">
                <img
                  src="/assets/success story/success event2.jpg"
                  alt="Success Story"
                  className="img-fluid w-100 h-100 object-fit-cover"
                />
              </div>
            ...
            <div className="row">
              <div className="col-12">
                <div className="d-flex justify-content-lg-start justify-content-center ">
                  <h3 className="text-decoration-underline ">Talent show</h3>
                </div>
              </div>
            </div>
            <div className="col-12 col-lg-5 col-md-6  d-lg-flex gap-2 Cardshoveranimate">
              <div className="col-12 col-lg-6  col-md-12 p-0">
                <img
                  src="/assets/success story/success event3.jpg"
                  alt="Success Story"
                  className="img-fluid w-100 h-100 object-fit-cover"
                />
              </div>
            ...
            <div className="col-12 col-lg-5 col-md-6  d-lg-flex gap-2 Cardshoveranimate">
              <div className="col-12 col-lg-6  col-md-12 p-0">
                <img
                  src="/assets/success story/success event4.jpg"
                  alt="Success Story"
                  className="img-fluid w-100 h-100 object-fit-cover"
                />
              </div>
            ...
            <div className="row">
              <div className="col-12">
                <div className="d-flex justify-content-lg-end justify-content-center">
                  <h3 className="text-decoration-underline ">Education</h3>
                </div>
              </div>
            </div>
            ...
            <div className="col-12 col-lg-5 col-md-6  d-lg-flex gap-2 Cardshoveranimate">
              <div className="col-12 col-lg-6  col-md-12 p-0">
                <img
                  src="/assets/success story/success event5.jpg"
                  alt="Success Story"
                  className="img-fluid w-100 h-100 object-fit-cover"
                />
              </div>
            ...
            <div className="col-12 col-lg-5 col-md-6  d-lg-flex gap-2 Cardshoveranimate">
              <div className="col-12 col-lg-6  col-md-12 p-0">
                <img
                  src="/assets/success story/success event6.jpg"
                  alt="Success Story"
                  className="img-fluid w-100 h-100 object-fit-cover"
                />
              </div>
