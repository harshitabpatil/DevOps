        ...
        <div className=' container py-lg-5 mt-lg-3 py-3 mt-3'>
          <div className='row'>
            <div className='col-12 col-lg-12 col-md-12'>
              <h3 className='text-center fw-bold'> Maya's story</h3>
        ...
        <div className='container-fluid'>
          <div className='row'>
            <div className='col-12 col-lg-12 col-md-12 w-100 img-fluid p-0 position-relative'>
              <img src="./assets/empower/event1  details.jpg" alt="empowerment.img" className='w-100 ' />
              <h5 className='position-absolute top-50 start-50 translate-middle text-white fs-4 divya-text'>Diviyasri</h5>
            </div>
